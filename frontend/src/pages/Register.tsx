...
export default function Register() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center bg-no-repeat py-8" style={{backgroundImage: `url('/src/public/assets/bg-claro-blur.jpeg')`}}>
